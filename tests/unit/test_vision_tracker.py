...
def test_multi_object_tracker_id_persistence_and_trajectory():
    ...
    det1 = [
        Detection(
            label="person",
            confidence=0.9,
            box=BoundingBox(xmin=0.2, ymin=0.2, xmax=0.4, ymax=0.6)
        )
    ]
    ...
    det2 = [
        Detection(
            label="person",
            confidence=0.92,
            box=BoundingBox(xmin=0.22, ymin=0.21, xmax=0.42, ymax=0.61)
        )
    ]
...
def test_multi_object_tracker_track_expiry():
    ...
    det = [
        Detection(
            label="car",
            confidence=0.85,
            box=BoundingBox(xmin=0.1, ymin=0.1, xmax=0.3, ymax=0.3)
        )
    ]
